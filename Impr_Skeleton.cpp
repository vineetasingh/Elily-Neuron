...
//	int avgdenLS, avgdenMS , avgdenHS, avgdenLM , avgdenMM, avgdenHM, avgdenLL, avgdenML, avgdenHL;
	...
	myfile << "dendritecalc"<< ","<<imname << "," << lines.size() << ", " << Ftotl << "," << Ftotm << "," << Ftoth << "," << Ftotwid << "," << smalwid << "," << midwid << "," << larwid << ", "<<FavgLS << "," << FavgMS << "," << FavgHS << "," << FavgLM << "," << FavgMM << "," << FavgHM << "," << FavgLL << "," << FavgML << "," << FavgHL <<endl;
...
void main()
{
	...
	myfile.open("DendriteMetricsadd2.csv");
